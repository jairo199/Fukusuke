<%-- 
    ...
    Created on : 23-jun-2019, 12:48:48
    Author     : Cheqcoslov
--%>
        ...
        <div class="listings" align="center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <hr>
                        <div class="footer_title" style="color: black;">Modificar producto</div>
                        <br>
                        <div class="container">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nombre"
                                            placeholder="Inserte nombre del producto" name="nombre">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="imagen">URL Imagen:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="imagen"
                                            placeholder="Insertar URL de imagen de producto" name="imagen">
                                    </div>
                                </div>
                                <div class="form-group">
