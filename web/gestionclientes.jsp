<%-- 
    Document   : gestionclientes.jsp
    Created on : 23-jun-2019, 12:46:34
    Author     : Cheqcoslov
--%>
                    ...
                    <!-- <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                ...
                                <ul>
                                    <li><button class="btn btn-success">Registar Cliente</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
                            ...
                            <table class="table table-hover" id="mytable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-warning btn-block" onclick="location.href='modificarcliente.html';">M</button</td> 
