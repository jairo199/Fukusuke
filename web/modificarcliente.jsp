<%-- 
    ...
    Created on : 23-jun-2019, 12:48:21
    Author     : Cheqcoslov
--%>
                        ...
                        <div class="container">
                            <form class="form-horizontal" action="/action_page.php">
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="rut">Run:</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="pass1">Telefono:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="telefono" placeholder="+56911223344"
                                            name="telefono">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="pass2">Dirección:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="direccion"
                                            placeholder="Ingrese nueva Dirección" name="direccion">
                                    </div>
                                </div>
                                <div class="form-group">
