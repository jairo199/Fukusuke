<%-- 
    ...
    Created on : 23-jun-2019, 12:50:35
    Author     : Cheqcoslov
--%>
        ...
        <div class="listings" align="center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <hr>
                        <div class="footer_title" style="color: black;">Registro de usuarios</div>
                        <br>
                        <div class="container">
                            <form class="form-horizontal" action="/action_page.php">
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="idusuario">ID de usuario:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="idusuario" placeholder="ID del usuario"
                                            name="idusuario" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="nombre">Nombres:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nombre"
                                            placeholder="Inserte nombres..." name="nombre">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="imagen">Apellidos:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="imagen"
                                            placeholder="Insertar apellidos..." name="imagen">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="precio">Rol:</label>
                                    <div class="col-sm-10">
