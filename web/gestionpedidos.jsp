<%-- 
    ...
    Created on : 23-jun-2019, 12:46:57
    Author     : Cheqcoslov
--%>
        ...
        <div class="listings">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                <div class="footer_title" style="color: black;">Gestión de pedidos</div>
                                <ul>
                                    <li><button class="btn btn-success" onclick="location.href='registrarpedido.html'">Registar pedido</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="col-xl-9">
                        <hr>
                        <div class="footer_title" style="color: black;">Pedidos</div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-warning btn-block" onclick="location.href='modificarpedido.html';">M</button</td> 
