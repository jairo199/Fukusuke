    ...
    <div class="super_container">
        ...
        <header class="header">
            ...
            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="submit ml-auto"><a href="index.html">Cerrar sesiÃ³n</a></div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                ...
                                <ul>
                                    <li><button class="btn btn-primary">Ver registros</button></li>
                                    <li><button class="btn btn-success">Registar</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
