		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
				  ...
				  <input type="text" class="form-control" id="nombre" placeholder="Ingrese rut sin puntos ni guión." required="true" maxlength="10">			    
				</div>
				...
				<div class="form-group">
				  ...
				  <input type="text" class="form-control" id="Dir" placeholder="ingrese Dirección" required="true">			    
				</div>
					...
					<div class="intro_content">
						...
						<div class="intro_text">
							...
							<p>
									...
									<span id="more"> La iniciativa de abrir un Sushi Delivery es debido al auge que ha tenido gastronómicamente en los últimos años la comida japonesa y lo práctico que es recibir en la comodidad del hogar un producto exótico, refinado y vanguardista.
