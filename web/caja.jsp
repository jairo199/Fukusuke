<%-- 
    Document   : caja.jsp
    Created on : 23-jun-2019, 12:46:15
    Author     : Cheqcoslov
--%>
...
<head>
    ...
    <script>
        ...
        <script>
            function myFunction() {
                alert("Cuadraje eliminado con exito!");
            }
        </script>
</head>
        ...
        <div class="listings">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                <div class="footer_title" style="color: black;">Cuadrajes</div>
                                <ul>
                                    <!-- <li><button class="btn btn-primary">Ver registros</button></li> -->
                                    <li><button class="btn btn-success" onclick="location.href='registrocuadraje.html';">Registar nuevo cuadraje</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="col-xl-9">
                        <hr>
                        <div class="footer_title" style="color: black;">Cuadrajes registrados</div>
                        <br>
                        <div class="container">
                            <table class="table table-hover">
                                    <div class="form-group">
                                            <input type="text" class="form-control pull-left" style="width:40%" id="search"
                                                placeholder="Buscador de cuadrajes...">
                                        </div>
                                        <br><br><br><br>
                                <thead>
                                    <th>Modificar</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td><button class="btn btn-warning btn-block" onclick="location.href='modificarcaja.html'">M</button</td> 
