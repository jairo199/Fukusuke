<%-- 
    Document   : modificarcaja
    Created on : 23-jun-2019, 12:48:07
    Author     : Cheqcoslov
--%>
...
<head>
    <title>Modificar datos de cuadraje</title>
    <meta charset="utf-8">
        ...
        <div class="listings" align="center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <hr>
                        <div class="footer_title" style="color: black;">Modificar datos de cuadraje</div>
                        <br>
                        <div class="container">
                            <form class="form-horizontal" action="/action_page.php">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="debito">Total Debito:</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="debito"
                                            placeholder="Inserte total debito..." name="debito">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-12" for="credito">Total Credito:</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="credito"
                                            placeholder="Insertar total credito..." name="credito">
                                    </div>
                                </div>
                                <div class="form-group">
                                        <label class="control-label col-sm-12" for="efectivo">Total Efectivo:</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="efectivo"
                                                placeholder="Insertar total efectivo..." name="efectivo">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <label class="control-label col-sm-12" for="total">Total Caja:</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="total"
                                                    placeholder="Insertar total caja..." name="total">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                <label class="control-label col-sm-12" for="usuario">Codigo usuario:</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="usuario"
                                                        placeholder="Insertar codigo usuario..." name="usuario">
                                                </div>
                                            </div>
                                <div class="form-group">
