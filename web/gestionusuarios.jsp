<%-- 
    ...
    Created on : 23-jun-2019, 12:47:45
    Author     : Cheqcoslov
--%>
...
<head>
    <title>Gestión de usarios</title>
    <meta charset="utf-8">
        ...
        <div class="listings">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                <div class="footer_title" style="color: black;">Gestión de Clientes</div>
                                <ul>
                                    <li><button class="btn btn-success" onclick="location.href='registrarusuario.html';">Registar usuario</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="col-xl-9">
                        <hr>
                        <div class="footer_title" style="color: black;">Gestión de usuarios</div>
                        ...
                        <div class="container">
                            <table class="table table-hover" id="mytable">
                                ...
                                <tbody>
                                    <tr>
                                        <!--Botones de modificación y de desactivación, respectivamente.-->
                                        <td><button class="btn btn-warning btn-block" onclick="location.href='modificarusuario.html';">M</button</td> 
                                        <td><button onclick="myFunction()" 
                                            class="btn btn-danger btn-block">D</button>
                                        </td>
                                        <td>Descripción A </td>
                                        <td>Descripción B</td>
                                        <td>Descripción C</td>
                                        <td>Descripción D</td>
                                        </button</td> <td><button class="btn btn-success btn-block">A</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
