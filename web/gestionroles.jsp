<%-- 
    ...
    Created on : 23-jun-2019, 12:47:30
    Author     : Cheqcoslov
--%>
        ...
        <div class="listings">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <div class="col">
                            <div class="footer_links">
                                <div class="footer_title" style="color: black;">Gestión de roles</div>
                                <ul>
                                    <li><button class="btn btn-success" onclick="location.href='agregarrol.html';">Agregar Rol</button></li>
                                </ul>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="col-xl-9">
                        <hr>
                        <div class="footer_title" style="color: black;">Listado de roles</div>
