...
<div class="super_container">
	...
	<div class="listing_container"  style="margin-top: 80px;">
		<div class="container">
			<div class="row">
				<div class="col">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="property_info">
									<div class="tag_price listing_price">$9.990</div>
									<div class="listing_name"><h1>@Producto</h1></div>
									
									<div class="listing_list">
										<ul>
											<li>DescripcciÃ³n: Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente officiis error ea asperiores facere nam ex optio blanditiis minima deleniti eveniet molestias, eum accusamus fugiat quos sed laboriosam harum velit.</li>
							...
							<div class="col-lg-6">
								<img src="images/arroz shushi.jpg" alt="Producto">
							</div>
							
							
						</div>
						<div class="row"><div class="load_more">
								<div class="button ml-auto mr-auto"><a href="#">Volver</a></div>
							</div></div>		
					</div>
