							...
							<div class="col-lg-6">
								<div class="property_info">
									...
									<div class="listing_list">
										<ul>
											<li>Descripcción: Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente officiis error ea asperiores facere nam ex optio blanditiis minima deleniti eveniet molestias, eum accusamus fugiat quos sed laboriosam harum velit.</li>
