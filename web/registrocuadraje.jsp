<%-- 
    Document   : registrocuadraje
    Created on : 23-jun-2019, 12:50:48
    Author     : Cheqcoslov
--%>
...
<head>
    <title>Registro de cuadraje</title>
    <meta charset="utf-8">
        ...
        <div class="listings" align="center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <hr>
                        <div class="footer_title" style="color: black;">Registro de cuadraje</div>
                        <br>
                        <div class="container">
